...
Server nodo = new Server("nodokey", "Display nodo 0", false);   
...
{   
    ...
    {   
        ...
        {   
            ...
            data = "|dips|" + ip + "|" + data;   
            msg = "msg#" + ip.Substring(0, ip.Length - 2).Replace('-', '.') + data;   
           if(Server_IPSPS(ref pips,ip)) m.filas.Add(msg);   
            ...
            for(int j=0;j<std.filas.Count;)
             {
              ...
              string ip;
              ip =p.GetDataString(0,0);
              if(Server_IPSPS(ref pips,ip))m.filas.Add("msg#" + ip.Replace('-', '.')+"|dips.act"); 
               
             for(int j=0;j<p.filas.Count;j++)
             {                               
